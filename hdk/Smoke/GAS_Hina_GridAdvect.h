...
/*
 * This is the same as the node [GAS_Advect] in Houdini
...
GAS_HINA_SUBSOLVER_CLASS(
		...
		THREADED_METHOD6(GAS_Hina_GridAdvect, OutField->shouldMultiThread(), _advect, float, dt, SIM_RawField *, OutField, const SIM_RawField *, InField, const SIM_RawField *, Flow_X, const SIM_RawField *, Flow_Y, const SIM_RawField *, Flow_Z);
